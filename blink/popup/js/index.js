...
async function renderRegisterPage() {
    ...
    const registerPageTemplage = await fetch(chrome.runtime.getURL('/popup/templates/register.html'));
    const registerPage = await registerPageTemplage.text();
...
async function renderLoginPage() {
    ...
    const loginPageTemplage = await fetch(chrome.runtime.getURL('/popup/templates/login.html'));
    const loginPage = await loginPageTemplage.text();
...
async function renderMainPage() {
    ...
    const mainPageTemplage = await fetch(chrome.runtime.getURL('/popup/templates/main.html'));
    const mainPage = await mainPageTemplage.text();
...
async function start() {
    ...
    if (storage.token) {
        const authPageTemplate = await fetch(chrome.runtime.getURL('/popup/templates/auth.html'));
        const authPage = await authPageTemplate.text();
